...
def generate_response(user_input, schema):
    ...
    - Create a reformed question that includes all necessary context
    - Make it self-contained and complete for database querying

    Example:
    Chat history: "Who directed Inception?"
        ...
        if validity == "valid":
            ...
            try:
                ...
                if satisfaction_level == "yes":
                    ...
                    - Presents all information from the Result. Dont Include full Previous conversation in your response
                    - Uses appropriate formatting ($,',',%,-) and tables
                    - Suggests relevant follow-up questions based on Result and Schema
                    - Dont Include Schema Information in your response and Follow-up Questions must show at the last in response
                    """)
                    ...
                    - ation - Combines both initial and follow-up information. Dont Include full Previous conversation in your response
                    - Uses appropriate formatting ($,',',%,-) and tables
                    - Suggests relevant follow-up questions based on Result and Schema
                    - Dont Include Schema Information in your response and Follow-up Questions must show at the last in response
                    """)
